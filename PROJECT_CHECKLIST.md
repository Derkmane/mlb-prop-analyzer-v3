...
- [x] Park model — proceed only with verified approved-source venue evidence and current-season validation.

Park-model completion evidence — Verified active-season BALLDONTLIE venue evidence preserved all 1,346 eligible games under 32 exact provider venue strings with no home-team inference or alias merging. Deterministic reconstruction reproduced all 14,265 frozen M8 validation predictions exactly before fitting a residual park layer. Real current-season chronological evaluation used 26,759 park-fit PA and 14,265 later-validation PA and selected `venue-hand-pool-2500`. Fixed-validation categorical log loss improved from `1.6620430674352507` to `1.6616058208441955`, fixed Hit log loss improved from `0.524892207427554` to `0.5247645196105157`, walk-forward categorical log loss improved from `1.6620430674352604` to `1.66157008198203`, and walk-forward Hit log loss improved from `0.5248922074275604` to `0.5247490665550644`. Evaluation-dataset SHA-256 is `074af50e2a881e7ab8df47480bc67e68c15ce03987bf153a587c86bb249712bb`; evaluation SHA-256 is `12c035a62014923f07d36e7374ed3df48d9375e1928d91a09b8cadbbb178c3c4`; typed factor artifact SHA-256 is `fd26dacedb507bb9a16b3bc18166ceaad2c66450322db525467247af2f67c33d`; park wrapper artifact SHA-256 is `de8bff49c81e17cffb1b857dc5f9db8c123e935c83880b778f02e4fe9ba54138`; and committed artifact file byte SHA-256 is `e9590a2d1f4bfda519750128947634aad1bd1b59d77630f73c7969d31ce74035`. The committed artifact contains 96 exact venue-and-hand mappings and applies handedness- and outcome-specific relative-rate multipliers to the full frozen terminal-outcome vector before one renormalization. The committed byte-lock regression and GitHub Actions verify run 591 passed 416 of 416 tests with typecheck, script checks, architecture, build, selected-side, and protective-architecture gates clean. Frozen M8 artifacts were unchanged; provider venue text remained exact; selected-side input, direct probability adjustment, prior-season evidence, production, ranking, and untouched-test access remained prohibited.
...
- Closed the M8.5 park-model item after approved-source venue evidence, exact frozen-base parity, and real active-season fixed-holdout and expanding walk-forward validation selected `venue-hand-pool-2500`.
- Preserved 32 exact provider venue strings and 96 venue-and-batter-hand mappings with no home-team inference, venue alias merging, selected-side input, direct probability adjustment, prior-season evidence, or untouched-test access.
- Added one production-disabled park artifact wrapper and runtime resolver that transform the full terminal-outcome vector in baseball units and renormalize once before statistic-distribution construction and settlement.
- Recorded exact evaluation-dataset, evaluation, typed-factor, park-wrapper, and committed file-byte SHA-256 identities.
- Recorded the committed byte-lock regression and GitHub Actions verify run 591 passing 416 of 416 tests with typecheck, script checks, architecture, build, selected-side, and protective-architecture gates clean.
- Preserved frozen M8 artifacts unchanged and kept production and ranking disabled.
...
- Deferred eligibility and participation probability to the M9 pregame runtime gate rather than treating it as a fitted current-season component.
