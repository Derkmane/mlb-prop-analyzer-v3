...
RULES_START_SHA256 = '1396fc2aa88104a35eb52d1945659d3317232e98614d3a13f5b18bf130e6463d'
MATH_START_SHA256 = '2829eb29de950cc6a206e4edf5c624a207b1fc9a43d4eefab96e5d94dcea5b7d'
RULES_FINAL_SHA256 = '729e342fef5e3b1ac07de89aa03b0b539dfa2a1df100b759f1265b30a6636d7e'
MATH_FINAL_SHA256 = 'cd18a6283cb39f8793813aa46b8e43775d2854ce40c7b2719616f8fe603c6457'
...
math_path = Path('CANONICAL_MATH_SPEC.md')
rules = rules_path.read_text()
math = math_path.read_text()

if sha256(rules.encode()).hexdigest() != RULES_START_SHA256:
    raise RuntimeError('PROJECT_RULES.md starting SHA-256 mismatch')
if sha256(math.encode()).hexdigest() != MATH_START_SHA256:
    raise RuntimeError('CANONICAL_MATH_SPEC.md starting SHA-256 mismatch')

rules = replace_once(rules, '**Version:** 2.4\\\n', '**Version:** 2.5\\\n', 'rules version')
...
math = replace_once(math, '**Version:** 1.5\n', '**Version:** 1.6\n', 'math version')
...
if sha256(rules.encode()).hexdigest() != RULES_FINAL_SHA256:
    raise RuntimeError('PROJECT_RULES.md final SHA-256 mismatch')
if sha256(math.encode()).hexdigest() != MATH_FINAL_SHA256:
    raise RuntimeError('CANONICAL_MATH_SPEC.md final SHA-256 mismatch')

rules_path.write_text(rules)
math_path.write_text(math)
print('PROJECT_RULES.md', sha256(rules_path.read_bytes()).hexdigest())
print('CANONICAL_MATH_SPEC.md', sha256(math_path.read_bytes()).hexdigest())
